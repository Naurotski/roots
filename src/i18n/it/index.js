export default {
  common: {
    ...
    enter: 'Entrare',
    exhibition: 'Mostra',
    internetUnreachable: 'Internet non raggiungibile',
    joinProject: 'Sostieni il progetto',
    maintenance:
      'Il nostro sito web è temporaneamente non disponibile a causa di lavori tecnici. Ricontrolla più tardi',
    more: 'più',
    offline: 'Nessuna connessione (offline)',
    ...
    verySlowInternet: 'Internet molto lento',
  ...
  dialoguePayment: {
    ...
    delivery:
      ...
      "Prima di completare l'acquisto, si prega di compilare i dati per la consegna. Questo ci permetterà di elaborare correttamente il vostro ordine e consegnare l'opera d'arte o il prodotto selezionato all'indirizzo specificato.",
    redirect:
  ...
  meta: {
    aboutDescription: ' Mostre di arte contemporanea a Pisa con realtà virtuale e aumentata.',
    artistsDescription:
  ...
  subscription: {
    ...
    annualAccess: 'Abbonamento Annuale',
    ...
    exhibitionPass: 'Pass Mostra (30 giorni)',
    month: 'mese',
    monthly: 'Abbonamento mensile',
    monthlyAccess: 'Abbonamento Mensile',
    noMethod: 'Nessun metodo di pagamento',
