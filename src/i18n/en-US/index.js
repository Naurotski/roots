export default {
  common: {
    ...
    joinProject: 'Support the project',
    maintenance:
    ...
    verySlowInternet: 'Very slow internet',
  ...
  meta: {
    aboutDescription: 'Contemporary art exhibitions in Pisa with virtual and augmented reality.',
    artistsDescription:
    ...
    virtualListDescription:
      'Explore Aorta Gallery’s virtual exhibitions—immersive 3D shows online. Browse current, upcoming and archive displays, and buy artworks directly in the virtual space.'
  },
  tickets: {
    adults: 'Adults',
  ...
  subscription: {
    ...
    annualAccess: 'Annual Membership',
    ...
    exhibitionPass: 'Exhibition Pass (30 days)',
    month: 'month',
    monthly: 'Monthly subscription',
    monthlyAccess: 'Monthly Membership',
    noMethod: 'No payment method',
